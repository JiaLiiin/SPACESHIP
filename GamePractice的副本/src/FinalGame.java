...
public class FinalGame extends JPanel implements MouseListener, ActionListener, KeyListener{
  ...
  xdirection xd=xdirection.STEADY;
  ...
  ydirection yd=ydirection.STEADY;
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    if (xd==xdirection.LEFT)
    {
      MovementX=-1;
    }
    if (xd==xdirection.RIGHT)
    {
      MovementX=1;
    }
    if (yd==ydirection.UP) 
    ...
    if (yd==ydirection.UP&&Bullet==false) 
    {
      MovementY=-1;
    }
    if (xd==xdirection.LEFT&&Bullet==false) 
    {
      MovementX=-1;
    }
    if (xd==xdirection.RIGHT&&Bullet==false) 
    {
      MovementX=1;
    }
    if (yd==ydirection.DOWN && Bullet==false)
    {
      MovementY=1;
    }
